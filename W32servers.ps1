$DCs=get-content .\serverlist.txt | sort

$LG=(Get-WinUserLanguageList).LanguageTag
#$LG=(get-culture).name

$TimeDC=@()
$Date=date

write-host "Server; SourceTime; TypeTM; NTPIP; VMICTimeEnabled"
...
#  $InputProvider=$t[3]
  ...
  write-host "$DC ; $b ; $TypeTM  ; $NTPIP ; $VMICTimeEnabled;$DateTime"
...
#|sort -property DC
echo $TimeDC |export-csv -path .\DCTimeServers.csv -delimiter ";" -encoding "ASCII" -notypeinformation
echo $TimeDC |out-gridview -title "NTP-Serveurs de temps"
